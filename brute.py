...
def cover():
    print """
     ...
     """
    runntek(GL+"           YouTube'@AnonPloitz ^_^...")
    time.sleep(1)
    print " "
    print RR+"  +============================================+"
    print GG+"  |¢â€€   HACK FACEBOOK By AnonPloitz   ¢â€¢   |"
    print RR+"  +============================================+"
    print WW+"  |            Script BY: DeepPloitz           |"
    print GG+"  |              Reza antes de usar            |"
    print WW+"  |            FACEBOOK: AnonPloitz            |"
    print Y+"   |             YouTube: AnonPloitz            |"
    print WW+"  |--------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ L.O.P ]        |"
    print WW+"  |--------------------------------------------|"
    print RR+"  +============================================+"
    print GG+"  |¢â€€   HACK FACEBOOK By AnonPloitz MOD  ¢â€¢|"
    print RR+"  +============================================+"     
...
def welcome():
        wel = GG+"""
No olvides suscribirte al Canal de Youtube "AnonPloitz" 
